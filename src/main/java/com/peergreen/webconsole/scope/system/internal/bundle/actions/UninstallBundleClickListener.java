 ...
 * Time: 13:19
 */
public class UninstallBundleClickListener implements Button.ClickListener {

    private final Bundle bundle;
    private final INotifierService notifierService;

    public UninstallBundleClickListener(final Bundle bundle, final INotifierService notifierService) {
        this.bundle = bundle;
